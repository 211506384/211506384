...
{
	CCLayerColor* colorBackground = CCLayerColor::create(ccc4(0, 0, 0, 150));
...
void MenuLayer::createMenu()
{
	...
	CCMenuItemLabel* resume = CCMenuItemLabel::create(CCLabelTTF::create("Start", fontName->getCString(), fontSize), this, menu_selector(MenuLayer::resume));
